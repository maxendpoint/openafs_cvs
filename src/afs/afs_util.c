...
RCSID
    ("$Header: /cvs/openafs/src/afs/afs_util.c,v 1.24 2006/04/05 16:04:28 shadow Exp $");
...
static void AFS_MD5_Init (struct md5 *m);
static void AFS_MD5_Update (struct md5 *m, const void *p, size_t len);
static void AFS_MD5_Final (void *res, struct md5 *m); /* u_int32_t res[4] */
...
static void
AFS_MD5_Update (struct md5 *m, const void *v, size_t len)
{
...
static void
AFS_MD5_Final (void *res, struct md5 *m)
{
