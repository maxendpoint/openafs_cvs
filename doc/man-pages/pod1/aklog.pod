...
Normally, B<aklog> uses the rxkad2b protocol to generate native K5 tokens.
This flag tells B<aklog> to instead use the krb524 translation service to
generate K4 tokens, which may be necessary for AFS cells that don't
support rxkad2b.
